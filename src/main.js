...
import { CastScene, CryptidsScene, GameOverScene, SelectScene, TitleScene, WinScene } from './scenes/TitleScene.js';
...
const config = {
  ...
  scene: [BootScene, TitleScene, CastScene, CryptidsScene, SelectScene, LevelScene, GameOverScene, WinScene],
};
